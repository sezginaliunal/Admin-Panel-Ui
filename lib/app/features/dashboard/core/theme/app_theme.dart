...
import 'package:test_project/app/features/dashboard/core/config/constants/colors/dark_colors.dart';
import 'package:test_project/app/features/dashboard/core/config/constants/colors/light_colors.dart';
  ...
  static ThemeData get light => ThemeData(
    ...
    dataTableTheme: DataTableThemeData(
      ...
      headingRowColor: WidgetStateProperty.all(
        const Color(0xFFF8FAFC), // soft açık gri
      ),
      headingRowHeight: 52,

      dataRowColor: WidgetStateProperty.resolveWith((states) {
        if (states.contains(WidgetState.hovered)) {
          return const Color(0xFFF1F5F9); // hover rengi
        }
        return Colors.white;
      }),
      dataRowMinHeight: 48,
